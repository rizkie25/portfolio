...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark shadow-sm" style="background-color: teal">
    <div class="container">
      <a class="navbar-brand" href="#">C I D group</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/article.php">Article</a>
          </li>
          <li class="nav-item">
  ...
  <section id="content" class="h-100 w-100 bg-white" style="box-sizing: border-box;">
    ...
    <div class="content-3-1 container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
      <div class="d-flex flex-lg-row flex-column align-items-center">
        ...
        <!-- Right Column -->
        <div class="right-column d-flex flex-column align-items-lg-start align-items-center text-lg-start text-start">
          <h3 class="padding-bottom">ABOUT US</h3>
          <ul class="p-0 m-0">
