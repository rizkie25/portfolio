...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#"><strong>Article</strong></a>
          </li>
          <li class="nav-item">
  ...
  <!-- Page Header-->
  <header class="masthead" style="background-image: url('../assets/images/senja altie.jpg')">
    <div class="container position-relative px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-md-10 col-lg-8 col-xl-7">
          <div class="post-heading">
            <h1>KEHIDUPAN DARI SUARA YANG PENUH KONTRA.</h1>
            <h2 class="subheading">A little story from us !</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-md-10 col-lg-8 col-xl-7">
          ...
          <p>
            Pada pukul 06:00 kami kembali membunyikan bel untuk membaca do'a pagi dan memberi tahukan kepada para santri untuk melaksanakan tandzif harian yang telah dijadwalkan, setelah itu kami memutar tutorial bahasa, shalawat, murrotal Al-Qur'an ataupun musik yang telah dijadwalkan: Senin-Kamis tutorial bahasa,
            Jum'at murrotal, Sabtu shalawat, dan Minggu musik.
            dan itu di putar selama 30 menit dari pukul 06:10-06:40 dan pada pukul 06:45 kami membunyikan bel pertama untuk memberi tahukan agar segera bersiap-siap untuk mengikuti pengajian pada pagi hari pada pukul 07:00 bel kedua dibunyikan untuk segera memasuki kelas masing-masing dan pada pukul 07:10 bel ketigapun berbunyi untuk menegaskan para santri segera memasuki kelas dan jika terlambat akan diberi sangsi oleh yang berkewajiban. Karena kegiatan mengaji akan dimulai pukul 07:20.
          </p>
          <p>
            Pukul 07:50 kegiatan mengaji selesai selang lima menit setelah itu bel peringatan dibunyikan bahwa kegiatan belajar sekolah akan di mulai pada pukul 08:00 dan setelah itu kegiatan yang paling saya suka yaitu take a news paper at the gate dan kami sepakat bahwa yang mengambil koran harus satu orang tidak boleh ada yang mengantar, kenapa harus begitu ? jadi ketika mengambil koran di gerbang itu tempatnya melewati wilayah putri ohh iya korannya ada tiga yah satu buat putra, satu putri, dan satu lagi untuk kantor sekolah dan setelah mengambil, kami mengantar kan koran tersebut ke kansis putri dan itu adalah challenge yang dimaksud dari kesepakatan kami tadi mungkin pansos dikit di putri bisa yah, setelah itu mengantar untuk kantor sekolah dan menyimpan koran putra, lalu mengikuti kegiatan belajar.
          </p>
          <p>
          ...
          <p>
            ...
            2. Muqaddimah
            <br>
            3. Pembacaan mahfudzat, Al-Qur'an, dan hadits
            <br>
            4. (bila ada do'a khusus untuk yang meninggal)
            <br>
            5. Pembacaan do'a untuk keluarga, orang sekitar,dan untuk pimpinan pondok tercinta juga
            <br>
            6. Pembacaan do'a untuk kesehatan & keberhasilan untuk kita semua
            <br>
            7. Memberi tahukan kegiatan setelah shalat magrib (malam jum'at & minggu memiliki kegiatan tersendiri selain pengajian di kelas masing-masing)
            <br>
            8. Salam penutup
          </p>
          <p>
            Dan itu keren loh, kalo kalian yang bukan anak ALTIE gak kayak gimana aslinya. Ohh iya buat malam minggukan ada pengajian rutinan bareng Abi jadi putri tuh ikut shalat jama'ah juga dan mereka dengerin apa yang kita omongin didepan jadi groginya double gitu dan pastinya putri pada kenal sama siapa yang ngomong didepan hehe.
          </p>
          <p>
            Lanjut, habis salam kita langsung pergi ke Ruang Informasi buat nyalain bel pengajian magrib sama kayak pas asar, pengajian berjalan sampai pukul 19:30 dan tak lama adzan isya berkumandang kami dari rumah betawi seusai pengajian yang digurui langsung oleh Abi pergi ke Ruang Informasi untuk menjawab adzan sampai Abi dari rumahnya datang menuju masjid untuk mengimami para santrina, dan sama seperti shalat magrib setelah shalat isya kami mempersiapkan diri untuk maju kedepan mimbar dan untuk hal-hal yang dibacakan adalal
          </p>
          <p>
            1. Salam pembuka
            <br>
            ...
            <br>
            4. Mengumumkan hal-hal apa saja yang sudah dititipkan seperti Extracurricular & keperluan lainnya
            <br>
            5. Mengumumkan bahwa jika ada kehilangan bisa datang ke Ruang Informasi (dari divisi Informasi)
            <br>
            6. Salam Penutup
          </p>
          <p>
            Setelah itu para santri bubar dari masjid pada pukul 20:00 untuk melakukan aktifitas masing-masing dan kami kembali ke Ruang Informasi dan mengumumkan kembali yang tadi diberitahukan di mimbar setelah itu membuka layanan memanggil & memberitahukan seperti saat siang, lalu pada pukul 21:00 bel dibunyikan untuk mengikuti kegiatan BM (belajar malam) sampai pukul 22:00 dan bel pulang mengisi akhir kegiatan pada hari ini, antusias para santri mengalahkan hening malam dan kami membacakan do'a sebelum tidur.
          </p>
          <p>
            Yah begitulah keseharian kami yang cukup membuat kami berpikir bahwa hidup tak melelahkan untuk sesuatu yang berarti dan patut untuk diperjuangkan.
          </p>
          <p>
        ...
        <div class="row col-md-6 nav-footer">
          ...
          <div class="col-md-4 mb-md-0 mb-3">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <a href="./members.php/#members">Members</a>
              </li>
            </ul>
          </div>
        </div>
