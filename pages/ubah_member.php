...
<div class="side">
    ...
    <div>
        <form method="POST" action="">
            ...
            <input type="radio" name="jenis_kelamin" value="Laki-laki" <?php if($mrd["jenis_kelamin"] == 'Laki-laki') {echo 'checked';} ?> >Laki-laki
            <br>
            <input type="radio" name="jenis_kelamin" value="Perempuan" <?php if($mrd["jenis_kelamin"] == 'Perempuan') {echo 'checked';} ?>>Perempuan
            <br><br><br>
            ...
            <br>
            <!-- Reset Button -->
            <button type="button"><a href="members.php">Kembali</a></button>
            <!-- Submit Button -->
